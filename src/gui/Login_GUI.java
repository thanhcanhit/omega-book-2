...
public class Login_GUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnl_login.setMaximumSize(new java.awt.Dimension(1366, 768));
        pnl_login.setMinimumSize(new java.awt.Dimension(1366, 768));
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        pnl_login.setPreferredSize(screenSize);
        ...
        pnl_login.add(pnl_changePasswordForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 400, 520));

        lbl_bachground.setBackground(new java.awt.Color(255, 255, 255));
        lbl_bachground.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lbl_bachground.setIcon(SVGIcon.getSVGIcon("/imgs/login/background.jpg"));
        lbl_bachground.setLabelFor(pnl_login);
        lbl_bachground.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        lbl_bachground.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        lbl_bachground.setMaximumSize(pnl_login.getPreferredSize());
        lbl_bachground.setMinimumSize(new java.awt.Dimension(320, 300));
        lbl_bachground.setPreferredSize(pnl_login.getPreferredSize());
        pnl_login.add(lbl_bachground, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1366, 768));

        add(pnl_login, java.awt.BorderLayout.CENTER);
